...
<asp:Content ID="Content1" ContentPlaceHolderID="contenido" runat="server">
    <div class="row">
        <div class="col-lg-6 mx-auto">
            ...
            <div class="card-body">
                <asp:GridView CssClass="table table-hover table-bordered" runat="server" ID="GrillaMedidor"
                    AutoGenerateColumns="false" OnRowCommand="GrillaMedidor_RowCommand" EmptyDataText="No hay Medidores Ingresados">
                    <Columns>
